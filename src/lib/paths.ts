...
export const SYSTEM_SKILLS_PATH = process.env.OPENCLAW_SYSTEM_SKILLS_PATH || '';
export const WORKSPACE_SKILLS_PATH = process.env.OPENCLAW_WORKSPACE_SKILLS_PATH || path.join(OPENCLAW_WORKSPACE, 'skills');
